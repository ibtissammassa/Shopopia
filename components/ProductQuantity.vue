    ...
    <div class="flex items-center justify-center w-full">
        ...
        <div class="flex">
            <label class="relative border-black border-t  border-b py-2 h-full">
                <span class="px-2 py-4 text-center "></span>
                <input min="" max="" class="px-2 text-center absolute outline-none inset-0 bg-opacity-0 w-full h-full" v-model="value" type="number">
            </label>
        </div>
