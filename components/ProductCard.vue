<template>
    <nuxt-link :to="`/products/${item.slug}`" class="p-5 cursor-pointer flex flex-col gap-y-2 w-full">
        ...
        <button @click.stop="addToCart" class="my-2 hover-bg-primary hover-color-white ease-in duration-400 w-28 text-primary font-bold border-primary text-sm py-2 px-2.5 border-2 rounded-full">
                Add to cart
        </button>
    </nuxt-link>
</template>
