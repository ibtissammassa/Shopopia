<template>
  <div>
    ...
    <div class="px-10 py-2 text-sm flex flex-col gap-y-2 md:flex-row md:justify-between items-center" :style="backgroundColor.length > 1 ? `background: linear-gradient(${backgroundColor}); color:${textColor}`: `background-color:${backgroundColor}; color:${textColor}`">
