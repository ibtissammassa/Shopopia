<template>
  <div  v-if="showBanner" class="relative bg-cover text-primary flex flex-col justify-center h-fit ">
    ...
    <div class="w-3/4 md:w-1/2 lg:gap-y-4 flex flex-col gap-y-3 absolute " :class="$store.state.language.code=='AR' ? 'md:pr-10 pr-6' : ' pl-6 md:pl-10'">
      <h1 class="text-4xl lg:text-6xl font-bold leading-normal leading-title">{{ title }}</h1>
