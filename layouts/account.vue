<template>
    <div class="bg-gray-50 relative transition-all delay-300" :class="$store.state.showHeaderMenu ? 'to-right' : ''">
        <component :is="'style'">
        ...
        <sections-header-top v-if="$settings.sections.headertop.active"></sections-header-top>
