<template>
  <div class="lg:px-16 px-7 py-8 flex flex-col">
    ...
    <div class="flex justify-between">
        ...
        <button v-if="items && items.length>0" @click.stop="addAllToCart" class="my-2 hover-bg-secondary ease-in duration-400 w-36 text-white font-bold border-white text-sm py-2.5 px-2.5 border-2 rounded-full bg-primary flex">
